...
<script>
/* eslint-disable */
import { getShippingOrdersByCustomerCode, getCustomerCodes, getAddressCode, getShipOrderInfo, createNewShipOrder, updateShipOrderInfo } from '@/api/shipping'
...
export default {
    components:{
        "shipping-index-edit-form": () => import('@/views/customerview/outbound/index-edit-form'),
        "shipping-index-table": () => import('@/views/customerview/outbound/index-table')
    },
    data() {
        return {
            loading: true,
    ...
    mounted() {
      getShippingOrdersByCustomerCode(customerCode).then(
          body => {
