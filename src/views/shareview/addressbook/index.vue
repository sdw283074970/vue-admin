    ...
    <div class="gb-maincontainer">
      ...
      <el-table
        ...
        <el-table-column
          ...
          width="450">
          <template slot-scope="scope">
            <el-button type="info" plain @click="editHandler(scope.row.id, scope.$index)">Info</el-button>
      ...
      <el-dialog title="Edit Customer" :visible.sync="dialogFormVisible">
        <el-form :model="form">
          <el-form-item label="Customer Name" :label-width="formLabelWidth">
            <el-input v-model="form.name" autocomplete="on" :disabled="true"></el-input>
          </el-form-item>
          <el-form-item label="Customer Code" :label-width="formLabelWidth">
            <el-input v-model="form.customerCode" autocomplete="on" :disabled="true"></el-input>
          </el-form-item>
          <el-form-item label="Department" :label-width="formLabelWidth">
            <el-input v-model="form.departmentCode" autocomplete="on" :disabled="true"></el-input>
          </el-form-item>
          <el-form-item label="Address Line 1" :label-width="formLabelWidth">
            <el-input v-model="form.firstAddressLine" autocomplete="on"></el-input>
          </el-form-item>
          <el-form-item label="Address Line 2" :label-width="formLabelWidth">
            <el-input v-model="form.secondAddressLine" autocomplete="on"></el-input>
          </el-form-item>
          <el-form-item label="Tel." :label-width="formLabelWidth">
            <el-input v-model="form.telNumber" autocomplete="on"></el-input>
          </el-form-item>
          <el-form-item label="Email" :label-width="formLabelWidth">
            <el-input v-model="form.emailAddress" autocomplete="on"></el-input>
          </el-form-item>
          <el-form-item label="Contact Person" :label-width="formLabelWidth">
            <el-input v-model="form.contactPerson" autocomplete="on"></el-input>
          </el-form-item>
          <el-form-item label="Warning Level(Ctns)" :label-width="formLabelWidth">
            <el-input v-model="form.warningQuantityLevel" autocomplete="on"></el-input>
          </el-form-item>
        </el-form>
