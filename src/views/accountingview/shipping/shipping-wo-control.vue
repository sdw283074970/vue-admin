  ...
  <div>
    ...
    <div style="margin-bottom:10px">
      ...
      <div style="margin-top:10px">
        ...
        <el-button :disabled="step!=6 || shipOrder.invoiceStatus != 'Closed'" class="gb-button" :loading="loading" type="primary" @click="shippedVisible=true">Mark Shipped</el-button>
