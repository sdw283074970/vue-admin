          ...
          <el-table-column type="expand">
            <template slot-scope="props">
                ...
                <div style="margin-top:10px;text-align: right;">
                    ...
                    <el-button @click="onConfirmClicked(props.row.id)" type="primary">Confirm Pick</el-button>
                </div>
            </template>
          </el-table-column>
          <el-table-column
...
<script>
import { getPltsInventory, pickCtnsInPlts, putbackPickDetail } from '@/api/shipping'
