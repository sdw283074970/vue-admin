        ...
        <template slot-scope="scope">
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item :disabled="scope.row.handlingStatus=='Finished'||scope.row.handlingStatus=='Confirmed'||shipOrder.invoiceStatus=='Closed'" @click.native="onUpdateClicked(scope.row.id)">Update</el-dropdown-item>
